...
import { FOVUS_ACCESSTOKEN,
  FOVUS_AUTHENTICATED,
  FOVUS_IDTOKEN, } from "./session.const";
...
const userPool = new CognitoUserPool({
  UserPoolId: import.meta.env.VITE_REACT_APP_USERPOOL_ID!,
  ClientId: import.meta.env.VITE_REACT_APP_APPCLIENT_ID!,
});

export const Login: React.FC = () => {

  console.log(import.meta.env.VITE_REACT_APP_USERPOOL_ID + " " + import.meta.env.VITE_REACT_APP_APPCLIENT_ID)
